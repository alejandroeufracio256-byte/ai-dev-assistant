...
class Surface(_BaseTraceType):
    ...
    @property
    def hidesurface(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def surfacecolorsrc(self): # -> tuple[Any, ...] | Self | None:
        """
        Sets the source reference on Chart Studio Cloud for
        `surfacecolor`.
    ...
    def __init__(self, arg=..., autocolorscale=..., cauto=..., cmax=..., cmid=..., cmin=..., coloraxis=..., colorbar=..., colorscale=..., connectgaps=..., contours=..., customdata=..., customdatasrc=..., hidesurface=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., opacityscale=..., reversescale=..., scene=..., showlegend=..., showscale=..., stream=..., surfacecolor=..., surfacecolorsrc=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., x=..., xcalendar=..., xhoverformat=..., xsrc=..., y=..., ycalendar=..., yhoverformat=..., ysrc=..., z=..., zcalendar=..., zhoverformat=..., zsrc=..., **kwargs) -> None:
        """
