...
class Mesh3d(_BaseTraceType):
    ...
    _valid_props = ...
    @property
    def alphahull(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def delaunayaxis(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def facecolor(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def facecolorsrc(self): # -> tuple[Any, ...] | Self | None:
        """
        Sets the source reference on Chart Studio Cloud for
        `facecolor`.
    ...
    @property
    def flatshading(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def i(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def intensity(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def intensitymode(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def intensitysrc(self): # -> tuple[Any, ...] | Self | None:
        """
        Sets the source reference on Chart Studio Cloud for
        `intensity`.
    ...
    @property
    def isrc(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def j(self): # -> tuple[Any, ...] | Self | None:
        """
        A vector of vertex indices, i.e. integer values between 0 and
    ...
    @property
    def jsrc(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def k(self): # -> tuple[Any, ...] | Self | None:
        """
        A vector of vertex indices, i.e. integer values between 0 and
    ...
    @property
    def ksrc(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def lighting(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def lightposition(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def vertexcolor(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def vertexcolorsrc(self): # -> tuple[Any, ...] | Self | None:
        """
        Sets the source reference on Chart Studio Cloud for
        `vertexcolor`.
    ...
    def __init__(self, arg=..., alphahull=..., autocolorscale=..., cauto=..., cmax=..., cmid=..., cmin=..., color=..., coloraxis=..., colorbar=..., colorscale=..., contour=..., customdata=..., customdatasrc=..., delaunayaxis=..., facecolor=..., facecolorsrc=..., flatshading=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., i=..., ids=..., idssrc=..., intensity=..., intensitymode=..., intensitysrc=..., isrc=..., j=..., jsrc=..., k=..., ksrc=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., reversescale=..., scene=..., showlegend=..., showscale=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., vertexcolor=..., vertexcolorsrc=..., visible=..., x=..., xcalendar=..., xhoverformat=..., xsrc=..., y=..., ycalendar=..., yhoverformat=..., ysrc=..., z=..., zcalendar=..., zhoverformat=..., zsrc=..., **kwargs) -> None:
        """
