...
class Heatmap(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., coloraxis=..., colorbar=..., colorscale=..., connectgaps=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hoverongaps=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., meta=..., metasrc=..., name=..., opacity=..., reversescale=..., showlegend=..., showscale=..., stream=..., text=..., textfont=..., textsrc=..., texttemplate=..., transpose=..., uid=..., uirevision=..., visible=..., x=..., x0=..., xaxis=..., xcalendar=..., xgap=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., xtype=..., y=..., y0=..., yaxis=..., ycalendar=..., ygap=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., ytype=..., z=..., zauto=..., zhoverformat=..., zmax=..., zmid=..., zmin=..., zorder=..., zsmooth=..., zsrc=..., **kwargs) -> None:
        """
