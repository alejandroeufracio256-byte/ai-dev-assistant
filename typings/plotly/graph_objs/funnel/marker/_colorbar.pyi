...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickformatstopdefaults(self): # -> tuple[Any, ...] | Self | None:
        """
        When used in a template (as layout.template.data.funnel.marker.
    ...
    def __init__(self, arg=..., bgcolor=..., bordercolor=..., borderwidth=..., dtick=..., exponentformat=..., labelalias=..., len=..., lenmode=..., minexponent=..., nticks=..., orientation=..., outlinecolor=..., outlinewidth=..., separatethousands=..., showexponent=..., showticklabels=..., showtickprefix=..., showticksuffix=..., thickness=..., thicknessmode=..., tick0=..., tickangle=..., tickcolor=..., tickfont=..., tickformat=..., tickformatstops=..., tickformatstopdefaults=..., ticklabeloverflow=..., ticklabelposition=..., ticklabelstep=..., ticklen=..., tickmode=..., tickprefix=..., ticks=..., ticksuffix=..., ticktext=..., ticktextsrc=..., tickvals=..., tickvalssrc=..., tickwidth=..., title=..., x=..., xanchor=..., xpad=..., xref=..., y=..., yanchor=..., ypad=..., yref=..., **kwargs) -> None:
        """
        ...
        tickformatstopdefaults
            When used in a template (as layout.template.data.funnel
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :class:`plotly.graph_objects.funnel.marker.colorbar.Tit
