...
class Volume(_BaseTraceType):
    ...
    @property
    def caps(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def isomax(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def isomin(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def opacityscale(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def slices(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def spaceframe(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def valuehoverformat(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., autocolorscale=..., caps=..., cauto=..., cmax=..., cmid=..., cmin=..., coloraxis=..., colorbar=..., colorscale=..., contour=..., customdata=..., customdatasrc=..., flatshading=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., isomax=..., isomin=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., opacityscale=..., reversescale=..., scene=..., showlegend=..., showscale=..., slices=..., spaceframe=..., stream=..., surface=..., text=..., textsrc=..., uid=..., uirevision=..., value=..., valuehoverformat=..., valuesrc=..., visible=..., x=..., xhoverformat=..., xsrc=..., y=..., yhoverformat=..., ysrc=..., z=..., zhoverformat=..., zsrc=..., **kwargs) -> None:
        """
