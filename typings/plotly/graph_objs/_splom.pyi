...
class Splom(_BaseTraceType):
    ...
    @property
    def diagonal(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def showlowerhalf(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def showupperhalf(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., customdata=..., customdatasrc=..., diagonal=..., dimensions=..., dimensiondefaults=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., marker=..., meta=..., metasrc=..., name=..., opacity=..., selected=..., selectedpoints=..., showlegend=..., showlowerhalf=..., showupperhalf=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., unselected=..., visible=..., xaxes=..., xhoverformat=..., yaxes=..., yhoverformat=..., **kwargs) -> None:
        """
