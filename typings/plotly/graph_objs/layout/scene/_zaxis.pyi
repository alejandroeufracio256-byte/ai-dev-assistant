...
class ZAxis(_BaseLayoutHierarchyType):
    ...
    @property
    def backgroundcolor(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def showaxeslabels(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def showbackground(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def spikesides(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., autorange=..., autorangeoptions=..., autotypenumbers=..., backgroundcolor=..., calendar=..., categoryarray=..., categoryarraysrc=..., categoryorder=..., color=..., dtick=..., exponentformat=..., gridcolor=..., gridwidth=..., hoverformat=..., labelalias=..., linecolor=..., linewidth=..., maxallowed=..., minallowed=..., minexponent=..., mirror=..., nticks=..., range=..., rangemode=..., separatethousands=..., showaxeslabels=..., showbackground=..., showexponent=..., showgrid=..., showline=..., showspikes=..., showticklabels=..., showtickprefix=..., showticksuffix=..., spikecolor=..., spikesides=..., spikethickness=..., tick0=..., tickangle=..., tickcolor=..., tickfont=..., tickformat=..., tickformatstops=..., tickformatstopdefaults=..., ticklen=..., tickmode=..., tickprefix=..., ticks=..., ticksuffix=..., ticktext=..., ticktextsrc=..., tickvals=..., tickvalssrc=..., tickwidth=..., title=..., type=..., visible=..., zeroline=..., zerolinecolor=..., zerolinewidth=..., **kwargs) -> None:
        """
