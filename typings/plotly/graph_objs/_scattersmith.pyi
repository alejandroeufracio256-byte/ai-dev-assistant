...
class Scattersmith(_BaseTraceType):
    ...
    @property
    def imag(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @imag.setter
    def imag(self, val): # -> None:
        ...
    
    @property
    def imagsrc(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @property
    def real(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    @real.setter
    def real(self, val): # -> None:
        ...
    
    @property
    def realsrc(self): # -> tuple[Any, ...] | Self | None:
        """
