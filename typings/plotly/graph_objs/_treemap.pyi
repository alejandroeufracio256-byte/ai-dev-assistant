...
class Treemap(_BaseTraceType):
    ...
    def __init__(self, arg=..., branchvalues=..., count=..., customdata=..., customdatasrc=..., domain=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextfont=..., labels=..., labelssrc=..., legend=..., legendgrouptitle=..., legendrank=..., legendwidth=..., level=..., marker=..., maxdepth=..., meta=..., metasrc=..., name=..., opacity=..., outsidetextfont=..., parents=..., parentssrc=..., pathbar=..., root=..., sort=..., stream=..., text=..., textfont=..., textinfo=..., textposition=..., textsrc=..., texttemplate=..., texttemplatesrc=..., tiling=..., uid=..., uirevision=..., values=..., valuessrc=..., visible=..., **kwargs) -> None:
        """
