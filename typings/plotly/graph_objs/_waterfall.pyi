...
class Waterfall(_BaseTraceType):
    ...
    def __init__(self, arg=..., alignmentgroup=..., base=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., decreasing=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., measure=..., measuresrc=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., offsetsrc=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., totals=..., uid=..., uirevision=..., visible=..., width=..., widthsrc=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., zorder=..., **kwargs) -> None:
        """
