...
def retry(min_wait=..., max_wait=..., max_delay=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
...
class OrcaConfig:
    ...
    @property
    def mapbox_access_token(self): # -> None:
        """
...
def to_image(fig, format=..., width=..., height=..., scale=..., validate=...): # -> bytes | Any:
    """
